...
___CSS_LOADER_EXPORT___.push([module.id, `:root {
    --primary-color: #6334d2;
    --secondary-color: #a78bfa;
    --hover-color: #6d28d9;
    --text-color: #333;
    --active-text-color: #4c1d95;
}
...
/* harmony export */ });
/* harmony import */ var _ResturantInteriorDesign_jpg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ResturantInteriorDesign.jpg */ "./src/ResturantInteriorDesign.jpg");
...
function createHomeTab() {
    ...
    const img = new Image();
    img.src = _ResturantInteriorDesign_jpg__WEBPACK_IMPORTED_MODULE_0__;
...
/***/ "./src/ResturantInteriorDesign.jpg":
/*!*****************************************!*\
  !*** ./src/ResturantInteriorDesign.jpg ***!
  \*****************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "52ea77fb1b08b0002940.jpg";
...
const createTabSwitcher = () => {
    ...
    return {
        switchToHome: (event) => {
            switchTab(_HomeTab_js__WEBPACK_IMPORTED_MODULE_0__.createHomeTab, event.target);
            setTheme('home');
        },
        switchToMenu: (event) => {
            switchTab(_MenuTab_js__WEBPACK_IMPORTED_MODULE_1__.createMenuTab, event.target);
            setTheme('menu');
        },
        switchToContact: (event) => {
            switchTab(_ContactTab_js__WEBPACK_IMPORTED_MODULE_2__.createContactTab, event.target);
            setTheme('contact');
        }
    };
};
